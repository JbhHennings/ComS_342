...
import abstractlang.AST.Program;
import arithlang.parser.AbstractLangLexer;
import arithlang.parser.AbstractLangParser;
...
public class Reader implements AutoCloseable {
    ...
    public Program parse(String programText) {
        ...
        AbstractLangParser p = getParser(new org.antlr.v4.runtime.CommonTokenStream(l));
        return p.program().ast;
    }

    protected Lexer getLexer(CharStream s) {
        return new AbstractLangLexer(s);
    }

    protected AbstractLangParser getParser(org.antlr.v4.runtime.CommonTokenStream s) {
        return new AbstractLangParser(s);
    }
